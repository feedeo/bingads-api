...
public class KeywordEstimatedPosition implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.Entity", "KeywordEstimatedPosition"));
    ...
    elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.Entity", "EstimatedPositions"));
    elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.Entity", "EstimatedPositionAndTraffic"));
    elemField.setMinOccurs(0);
    elemField.setNillable(true);
    elemField.setItemQName(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.AdInsight.Api.DataContract.Entity", "EstimatedPositionAndTraffic"));
    typeDesc.addFieldDesc(elemField);
  }

  private java.lang.String keyword;
  private com.microsoft.bingads.v10.adinsight.entity.EstimatedPositionAndTraffic[] estimatedPositions;
  ...
  public KeywordEstimatedPosition(
          ...
          com.microsoft.bingads.v10.adinsight.entity.EstimatedPositionAndTraffic[] estimatedPositions) {
   ...
   */
  public com.microsoft.bingads.v10.adinsight.entity.EstimatedPositionAndTraffic[] getEstimatedPositions() {
    return estimatedPositions;
  }
   ...
   */
  public void setEstimatedPositions(com.microsoft.bingads.v10.adinsight.entity.EstimatedPositionAndTraffic[] estimatedPositions) {
    this.estimatedPositions = estimatedPositions;
  }
