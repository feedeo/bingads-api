...
public class DeleteCampaignsResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">DeleteCampaignsResponse"));
  ...
  /**
   * Gets the partialErrors value for this DeleteCampaignsResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this DeleteCampaignsResponse.
   *
   * @param partialErrors
   */
