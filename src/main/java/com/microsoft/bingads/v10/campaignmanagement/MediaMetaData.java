...
public class MediaMetaData implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "MediaMetaData"));
    ...
    elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "MediaType"));
    ...
    elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "Representations"));
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "MediaRepresentation"));
    elemField.setMinOccurs(0);
    elemField.setNillable(true);
    elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "MediaRepresentation"));
    typeDesc.addFieldDesc(elemField);
    elemField = new org.apache.axis.description.ElementDesc();
  ...
  private com.microsoft.bingads.v10.campaignmanagement.MediaRepresentation[] representations;
  ...
  public MediaMetaData(
          ...
          com.microsoft.bingads.v10.campaignmanagement.MediaRepresentation[] representations,
   ...
   */
  public com.microsoft.bingads.v10.campaignmanagement.MediaRepresentation[] getRepresentations() {
    return representations;
  }
   ...
   */
  public void setRepresentations(com.microsoft.bingads.v10.campaignmanagement.MediaRepresentation[] representations) {
    this.representations = representations;
  }
