...
public class DeleteMediaResponse implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(DeleteMediaResponse.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">DeleteMediaResponse"));
  ...
  /**
   * Gets the partialErrors value for this DeleteMediaResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this DeleteMediaResponse.
   *
   * @param partialErrors
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof DeleteMediaResponse)) return false;
    DeleteMediaResponse other = (DeleteMediaResponse) obj;
