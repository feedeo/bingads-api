...
public class AgeTargetBid implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "AgeTargetBid"));
    ...
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "AgeRange"));
  ...
  private com.microsoft.bingads.v10.campaignmanagement.AgeRange age;
  ...
  public AgeTargetBid(
          com.microsoft.bingads.v10.campaignmanagement.AgeRange age,
          int bidAdjustment) {
    this.age = age;
   ...
   * @return age
   */
  public com.microsoft.bingads.v10.campaignmanagement.AgeRange getAge() {
    return age;
  }
   ...
   * @param age
   */
  public void setAge(com.microsoft.bingads.v10.campaignmanagement.AgeRange age) {
    this.age = age;
  }
