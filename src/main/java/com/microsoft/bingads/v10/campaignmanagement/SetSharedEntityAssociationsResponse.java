/**
 * SetSharedEntityAssociationsResponse.java
 * <p>
...
public class SetSharedEntityAssociationsResponse implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(SetSharedEntityAssociationsResponse.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">SetSharedEntityAssociationsResponse"));
  ...
  /**
   * Gets the partialErrors value for this SetSharedEntityAssociationsResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this SetSharedEntityAssociationsResponse.
   *
   * @param partialErrors
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof SetSharedEntityAssociationsResponse)) return false;
    SetSharedEntityAssociationsResponse other = (SetSharedEntityAssociationsResponse) obj;
