...
public class UpdateAdGroupsResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">UpdateAdGroupsResponse"));
  ...
  /**
   * Gets the partialErrors value for this UpdateAdGroupsResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this UpdateAdGroupsResponse.
   *
   * @param partialErrors
   */
