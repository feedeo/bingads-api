...
public class GetTargetsInfoFromLibraryResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">GetTargetsInfoFromLibraryResponse"));
    org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
    elemField.setFieldName("targetsInfo");
    elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "TargetsInfo"));
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "TargetInfo"));
    elemField.setMinOccurs(0);
    elemField.setNillable(true);
    elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "TargetInfo"));
    typeDesc.addFieldDesc(elemField);
  }

  private com.microsoft.bingads.v10.campaignmanagement.TargetInfo[] targetsInfo;
  ...
  public GetTargetsInfoFromLibraryResponse(
          com.microsoft.bingads.v10.campaignmanagement.TargetInfo[] targetsInfo) {
   ...
   * @return targetsInfo
   */
  public com.microsoft.bingads.v10.campaignmanagement.TargetInfo[] getTargetsInfo() {
    return targetsInfo;
  }
   ...
   * @param targetsInfo
   */
  public void setTargetsInfo(com.microsoft.bingads.v10.campaignmanagement.TargetInfo[] targetsInfo) {
    this.targetsInfo = targetsInfo;
  }
