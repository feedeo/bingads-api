...
public class SetNegativeSitesToCampaignsResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">SetNegativeSitesToCampaignsResponse"));
  ...
  /**
   * Gets the partialErrors value for this SetNegativeSitesToCampaignsResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this SetNegativeSitesToCampaignsResponse.
   *
   * @param partialErrors
   */
