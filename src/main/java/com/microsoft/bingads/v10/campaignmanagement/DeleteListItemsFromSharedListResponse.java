/**
 * DeleteListItemsFromSharedListResponse.java
 * <p>
...
public class DeleteListItemsFromSharedListResponse implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(DeleteListItemsFromSharedListResponse.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">DeleteListItemsFromSharedListResponse"));
  ...
  /**
   * Gets the partialErrors value for this DeleteListItemsFromSharedListResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this DeleteListItemsFromSharedListResponse.
   *
   * @param partialErrors
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof DeleteListItemsFromSharedListResponse)) return false;
    DeleteListItemsFromSharedListResponse other = (DeleteListItemsFromSharedListResponse) obj;
