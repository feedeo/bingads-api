...
public class UpdateCampaignsResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">UpdateCampaignsResponse"));
  ...
  /**
   * Gets the partialErrors value for this UpdateCampaignsResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this UpdateCampaignsResponse.
   *
   * @param partialErrors
   */
