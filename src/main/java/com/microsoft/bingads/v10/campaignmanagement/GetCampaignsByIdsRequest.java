...
public class GetCampaignsByIdsRequest implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">GetCampaignsByIdsRequest"));
  ...
  /**
   * Gets the returnAdditionalFields value for this GetCampaignsByIdsRequest.
   *
  ...
  /**
   * Sets the returnAdditionalFields value for this GetCampaignsByIdsRequest.
   *
