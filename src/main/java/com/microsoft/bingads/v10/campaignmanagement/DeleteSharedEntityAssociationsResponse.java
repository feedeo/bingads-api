/**
 * DeleteSharedEntityAssociationsResponse.java
 * <p>
...
public class DeleteSharedEntityAssociationsResponse implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(DeleteSharedEntityAssociationsResponse.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">DeleteSharedEntityAssociationsResponse"));
  ...
  /**
   * Gets the partialErrors value for this DeleteSharedEntityAssociationsResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this DeleteSharedEntityAssociationsResponse.
   *
   * @param partialErrors
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof DeleteSharedEntityAssociationsResponse)) return false;
    DeleteSharedEntityAssociationsResponse other = (DeleteSharedEntityAssociationsResponse) obj;
