/**
 * GetSharedEntityAssociationsByEntityIdsResponse.java
 * <p>
...
public class GetSharedEntityAssociationsByEntityIdsResponse implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(GetSharedEntityAssociationsByEntityIdsResponse.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">GetSharedEntityAssociationsByEntityIdsResponse"));
  ...
  /**
   * Gets the associations value for this GetSharedEntityAssociationsByEntityIdsResponse.
   *
   * @return associations
   */
  ...
  /**
   * Sets the associations value for this GetSharedEntityAssociationsByEntityIdsResponse.
   *
   * @param associations
   */
  ...
  /**
   * Gets the partialErrors value for this GetSharedEntityAssociationsByEntityIdsResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this GetSharedEntityAssociationsByEntityIdsResponse.
   *
   * @param partialErrors
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof GetSharedEntityAssociationsByEntityIdsResponse)) return false;
    GetSharedEntityAssociationsByEntityIdsResponse other = (GetSharedEntityAssociationsByEntityIdsResponse) obj;
