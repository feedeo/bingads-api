...
public class AccountMigrationStatusesInfo implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "AccountMigrationStatusesInfo"));
    ...
    elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "MigrationStatusInfo"));
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "MigrationStatusInfo"));
    elemField.setMinOccurs(0);
    elemField.setNillable(true);
    elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "MigrationStatusInfo"));
    typeDesc.addFieldDesc(elemField);
  }

  private long accountId;
  private com.microsoft.bingads.v10.campaignmanagement.MigrationStatusInfo[] migrationStatusInfo;
  ...
  public AccountMigrationStatusesInfo(
          long accountId,
          com.microsoft.bingads.v10.campaignmanagement.MigrationStatusInfo[] migrationStatusInfo) {
   ...
   */
  public com.microsoft.bingads.v10.campaignmanagement.MigrationStatusInfo[] getMigrationStatusInfo() {
    return migrationStatusInfo;
  }
   ...
   */
  public void setMigrationStatusInfo(com.microsoft.bingads.v10.campaignmanagement.MigrationStatusInfo[] migrationStatusInfo) {
    this.migrationStatusInfo = migrationStatusInfo;
  }
