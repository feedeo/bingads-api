...
public class SitePlacement implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "SitePlacement"));
    ...
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "SitePlacementStatus"));
    elemField.setMinOccurs(0);
    elemField.setNillable(true);
    typeDesc.addFieldDesc(elemField);
    elemField = new org.apache.axis.description.ElementDesc();
  ...
  private com.microsoft.bingads.v10.campaignmanagement.SitePlacementStatus status;
  ...
  public SitePlacement(
          ...
          com.microsoft.bingads.v10.campaignmanagement.SitePlacementStatus status,
   ...
   * @return status
   */
  public com.microsoft.bingads.v10.campaignmanagement.SitePlacementStatus getStatus() {
    return status;
  }
   ...
   * @param status
   */
  public void setStatus(com.microsoft.bingads.v10.campaignmanagement.SitePlacementStatus status) {
    this.status = status;
  }
