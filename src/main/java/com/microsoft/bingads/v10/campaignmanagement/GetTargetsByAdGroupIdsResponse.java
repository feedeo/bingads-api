...
public class GetTargetsByAdGroupIdsResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">GetTargetsByAdGroupIdsResponse"));
  ...
  /**
   * Gets the partialErrors value for this GetTargetsByAdGroupIdsResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this GetTargetsByAdGroupIdsResponse.
   *
   * @param partialErrors
   */
