/**
 * SetSharedEntityAssociationsRequest.java
 * <p>
...
public class SetSharedEntityAssociationsRequest implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(SetSharedEntityAssociationsRequest.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">SetSharedEntityAssociationsRequest"));
  ...
  /**
   * Gets the associations value for this SetSharedEntityAssociationsRequest.
   *
   * @return associations
   */
  ...
  /**
   * Sets the associations value for this SetSharedEntityAssociationsRequest.
   *
   * @param associations
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof SetSharedEntityAssociationsRequest)) return false;
    SetSharedEntityAssociationsRequest other = (SetSharedEntityAssociationsRequest) obj;
