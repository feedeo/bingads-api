/**
 * AppealEditorialRejectionsResponse.java
 * <p>
...
public class AppealEditorialRejectionsResponse implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(AppealEditorialRejectionsResponse.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">AppealEditorialRejectionsResponse"));
  ...
  /**
   * Gets the partialErrors value for this AppealEditorialRejectionsResponse.
   *
  ...
  /**
   * Sets the partialErrors value for this AppealEditorialRejectionsResponse.
   *
   * @param partialErrors
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof AppealEditorialRejectionsResponse)) return false;
    AppealEditorialRejectionsResponse other = (AppealEditorialRejectionsResponse) obj;
