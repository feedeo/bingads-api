...
public class GetAccountMigrationStatusesResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">GetAccountMigrationStatusesResponse"));
    org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
    elemField.setFieldName("migrationStatuses");
    elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "MigrationStatuses"));
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "AccountMigrationStatusesInfo"));
    elemField.setMinOccurs(0);
    elemField.setNillable(true);
    elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "AccountMigrationStatusesInfo"));
    typeDesc.addFieldDesc(elemField);
  }

  private com.microsoft.bingads.v10.campaignmanagement.AccountMigrationStatusesInfo[] migrationStatuses;
  ...
  public GetAccountMigrationStatusesResponse(
          com.microsoft.bingads.v10.campaignmanagement.AccountMigrationStatusesInfo[] migrationStatuses) {
   ...
   */
  public com.microsoft.bingads.v10.campaignmanagement.AccountMigrationStatusesInfo[] getMigrationStatuses() {
    return migrationStatuses;
  }
   ...
   */
  public void setMigrationStatuses(com.microsoft.bingads.v10.campaignmanagement.AccountMigrationStatusesInfo[] migrationStatuses) {
    this.migrationStatuses = migrationStatuses;
  }
