...
public class GetBMCStoresByCustomerIdResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">GetBMCStoresByCustomerIdResponse"));
    org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
    elemField.setFieldName("BMCStores");
    elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "BMCStores"));
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "BMCStore"));
    elemField.setMinOccurs(0);
    elemField.setNillable(true);
    elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "BMCStore"));
    typeDesc.addFieldDesc(elemField);
  }

  private com.microsoft.bingads.v10.campaignmanagement.BMCStore[] BMCStores;
  ...
  public GetBMCStoresByCustomerIdResponse(
          com.microsoft.bingads.v10.campaignmanagement.BMCStore[] BMCStores) {
   ...
   * @return BMCStores
   */
  public com.microsoft.bingads.v10.campaignmanagement.BMCStore[] getBMCStores() {
    return BMCStores;
  }
   ...
   * @param BMCStores
   */
  public void setBMCStores(com.microsoft.bingads.v10.campaignmanagement.BMCStore[] BMCStores) {
    this.BMCStores = BMCStores;
  }
