...
public class GetCampaignSizesByAccountIdResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">GetCampaignSizesByAccountIdResponse"));
    org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
    elemField.setFieldName("campaignSizes");
    elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "CampaignSizes"));
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "CampaignSize"));
    elemField.setMinOccurs(0);
    elemField.setNillable(true);
    elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "CampaignSize"));
    typeDesc.addFieldDesc(elemField);
  }

  private com.microsoft.bingads.v10.campaignmanagement.CampaignSize[] campaignSizes;
  ...
  public GetCampaignSizesByAccountIdResponse(
          com.microsoft.bingads.v10.campaignmanagement.CampaignSize[] campaignSizes) {
   ...
   */
  public com.microsoft.bingads.v10.campaignmanagement.CampaignSize[] getCampaignSizes() {
    return campaignSizes;
  }
   ...
   * @param campaignSizes
   */
  public void setCampaignSizes(com.microsoft.bingads.v10.campaignmanagement.CampaignSize[] campaignSizes) {
    this.campaignSizes = campaignSizes;
  }
