/**
 * GetAdGroupCriterionsByIdsRequest.java
 * <p>
...
public class GetAdGroupCriterionsByIdsRequest implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(GetAdGroupCriterionsByIdsRequest.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", ">GetAdGroupCriterionsByIdsRequest"));
  ...
  /**
   * Gets the accountId value for this GetAdGroupCriterionsByIdsRequest.
   *
   * @return accountId
   */
  ...
  /**
   * Sets the accountId value for this GetAdGroupCriterionsByIdsRequest.
   *
   * @param accountId
   */
  ...
  /**
   * Gets the adGroupCriterionIds value for this GetAdGroupCriterionsByIdsRequest.
   *
  ...
  /**
   * Sets the adGroupCriterionIds value for this GetAdGroupCriterionsByIdsRequest.
   *
  ...
  /**
   * Gets the adGroupId value for this GetAdGroupCriterionsByIdsRequest.
   *
   * @return adGroupId
   */
  ...
  /**
   * Sets the adGroupId value for this GetAdGroupCriterionsByIdsRequest.
   *
   * @param adGroupId
   */
  ...
  /**
   * Gets the criterionType value for this GetAdGroupCriterionsByIdsRequest.
   *
  ...
  /**
   * Sets the criterionType value for this GetAdGroupCriterionsByIdsRequest.
   *
   * @param criterionType
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof GetAdGroupCriterionsByIdsRequest)) return false;
    GetAdGroupCriterionsByIdsRequest other = (GetAdGroupCriterionsByIdsRequest) obj;
