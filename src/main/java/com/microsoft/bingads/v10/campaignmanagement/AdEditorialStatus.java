...
public class AdEditorialStatus implements java.io.Serializable {
  ...
  public static final AdEditorialStatus ActiveLimited = new AdEditorialStatus(_ActiveLimited);
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(AdEditorialStatus.class);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "AdEditorialStatus"));
  }
