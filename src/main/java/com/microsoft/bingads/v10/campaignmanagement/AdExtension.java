...
public class AdExtension implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "AdExtension"));
    ...
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "AdExtensionStatus"));
    elemField.setMinOccurs(0);
    elemField.setNillable(true);
    typeDesc.addFieldDesc(elemField);
    elemField = new org.apache.axis.description.ElementDesc();
    ...
    elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v10", "Version"));
  ...
  private com.microsoft.bingads.v10.campaignmanagement.AdExtensionStatus status;
   ...
   * @return status
   */
  public com.microsoft.bingads.v10.campaignmanagement.AdExtensionStatus getStatus() {
    return status;
  }
   ...
   * @param status
   */
  public void setStatus(com.microsoft.bingads.v10.campaignmanagement.AdExtensionStatus status) {
    this.status = status;
  }
