...
package com.microsoft.bingads.v10.adapi;

public class AdApiFaultDetail extends com.microsoft.bingads.v10.adapi.ApplicationFault implements java.io.Serializable {
  // Type metadata
  ...
  private com.microsoft.bingads.v10.adapi.AdApiError[] errors;
  ...
  public AdApiFaultDetail(
          ...
          com.microsoft.bingads.v10.adapi.AdApiError[] errors) {
    super(
            trackingId);
    this.errors = errors;
  }
   ...
   * @return errors
   */
  public com.microsoft.bingads.v10.adapi.AdApiError[] getErrors() {
    return errors;
  }
   ...
   * @param errors
   */
  public void setErrors(com.microsoft.bingads.v10.adapi.AdApiError[] errors) {
    this.errors = errors;
  }
