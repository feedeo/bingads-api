...
public class DeleteAdsResponse implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">DeleteAdsResponse"));
    ...
    /**
     * Gets the partialErrors value for this DeleteAdsResponse.
     *
    ...
    /**
     * Sets the partialErrors value for this DeleteAdsResponse.
     *
     * @param partialErrors
     */
