...
public class InStoreTransactionGoal extends com.microsoft.bingads.v11.campaignmanagement.ConversionGoal implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(InStoreTransactionGoal.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", "InStoreTransactionGoal"));
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InStoreTransactionGoal)) return false;
        InStoreTransactionGoal other = (InStoreTransactionGoal) obj;
