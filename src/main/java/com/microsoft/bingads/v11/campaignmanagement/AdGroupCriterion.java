...
public class AdGroupCriterion implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", "AdGroupCriterion"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", "AdGroupCriterionStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
    ...
    private com.microsoft.bingads.v11.campaignmanagement.AdGroupCriterionStatus status;
     ...
     * @return status
     */
    public com.microsoft.bingads.v11.campaignmanagement.AdGroupCriterionStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.microsoft.bingads.v11.campaignmanagement.AdGroupCriterionStatus status) {
        this.status = status;
    }
