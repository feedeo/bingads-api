/**
 * DeleteAdExtensionsAssociationsResponse.java
 * <p>
...
public class DeleteAdExtensionsAssociationsResponse implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(DeleteAdExtensionsAssociationsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">DeleteAdExtensionsAssociationsResponse"));
    ...
    /**
     * Gets the partialErrors value for this DeleteAdExtensionsAssociationsResponse.
     *
    ...
    /**
     * Sets the partialErrors value for this DeleteAdExtensionsAssociationsResponse.
     *
     * @param partialErrors
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeleteAdExtensionsAssociationsResponse)) return false;
        DeleteAdExtensionsAssociationsResponse other = (DeleteAdExtensionsAssociationsResponse) obj;
