/**
 * UpdateAdExtensionsResponse.java
 * <p>
...
public class UpdateAdExtensionsResponse implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(UpdateAdExtensionsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">UpdateAdExtensionsResponse"));
    ...
    /**
     * Gets the nestedPartialErrors value for this UpdateAdExtensionsResponse.
     *
    ...
    /**
     * Sets the nestedPartialErrors value for this UpdateAdExtensionsResponse.
     *
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateAdExtensionsResponse)) return false;
        UpdateAdExtensionsResponse other = (UpdateAdExtensionsResponse) obj;
