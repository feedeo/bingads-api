/**
 * AddConversionGoalsRequest.java
 * <p>
...
public class AddConversionGoalsRequest implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(AddConversionGoalsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">AddConversionGoalsRequest"));
    ...
    /**
     * Gets the conversionGoals value for this AddConversionGoalsRequest.
     *
    ...
    /**
     * Sets the conversionGoals value for this AddConversionGoalsRequest.
     *
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddConversionGoalsRequest)) return false;
        AddConversionGoalsRequest other = (AddConversionGoalsRequest) obj;
