...
public class AddLabelsRequest implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(AddLabelsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">AddLabelsRequest"));
    ...
    /**
     * Gets the labels value for this AddLabelsRequest.
     *
     * @return labels
     */
    ...
    /**
     * Sets the labels value for this AddLabelsRequest.
     *
     * @param labels
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddLabelsRequest)) return false;
        AddLabelsRequest other = (AddLabelsRequest) obj;
