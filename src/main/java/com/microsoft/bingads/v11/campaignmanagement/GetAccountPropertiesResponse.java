/**
 * GetAccountPropertiesResponse.java
 * <p>
...
public class GetAccountPropertiesResponse implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(GetAccountPropertiesResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">GetAccountPropertiesResponse"));
    ...
    /**
     * Gets the accountProperties value for this GetAccountPropertiesResponse.
     *
    ...
    /**
     * Sets the accountProperties value for this GetAccountPropertiesResponse.
     *
    ...
    /**
     * Gets the partialErrors value for this GetAccountPropertiesResponse.
     *
    ...
    /**
     * Sets the partialErrors value for this GetAccountPropertiesResponse.
     *
     * @param partialErrors
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetAccountPropertiesResponse)) return false;
        GetAccountPropertiesResponse other = (GetAccountPropertiesResponse) obj;
