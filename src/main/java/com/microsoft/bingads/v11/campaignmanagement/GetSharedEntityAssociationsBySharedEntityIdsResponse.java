...
public class GetSharedEntityAssociationsBySharedEntityIdsResponse implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">GetSharedEntityAssociationsBySharedEntityIdsResponse"));
