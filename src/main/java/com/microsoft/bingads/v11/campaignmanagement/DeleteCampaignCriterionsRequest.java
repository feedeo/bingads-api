...
public class DeleteCampaignCriterionsRequest implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">DeleteCampaignCriterionsRequest"));
    ...
    /**
     * Gets the campaignId value for this DeleteCampaignCriterionsRequest.
     *
     * @return campaignId
     */
    ...
    /**
     * Sets the campaignId value for this DeleteCampaignCriterionsRequest.
     *
     * @param campaignId
     */
