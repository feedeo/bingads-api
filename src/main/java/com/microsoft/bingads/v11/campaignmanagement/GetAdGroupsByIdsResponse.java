...
public class GetAdGroupsByIdsResponse implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">GetAdGroupsByIdsResponse"));
    ...
    /**
     * Gets the partialErrors value for this GetAdGroupsByIdsResponse.
     *
    ...
    /**
     * Sets the partialErrors value for this GetAdGroupsByIdsResponse.
     *
     * @param partialErrors
     */
