...
public class AddCampaignCriterionsResponse implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">AddCampaignCriterionsResponse"));
    ...
    /**
     * Gets the isMigrated value for this AddCampaignCriterionsResponse.
     *
     * @return isMigrated
     */
    ...
    /**
     * Sets the isMigrated value for this AddCampaignCriterionsResponse.
     *
     * @param isMigrated
     */
