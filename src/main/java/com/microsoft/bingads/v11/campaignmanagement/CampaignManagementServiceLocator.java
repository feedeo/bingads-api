...
public class CampaignManagementServiceLocator extends org.apache.axis.client.Service implements com.microsoft.bingads.v11.campaignmanagement.CampaignManagementService {

    // Use to get a proxy class for BasicHttpBinding_ICampaignManagementService
    private java.lang.String BasicHttpBinding_ICampaignManagementService_address = "https://campaign.api.bingads.microsoft.com/Api/Advertiser/CampaignManagement/V11/CampaignManagementService.svc";
    ...
    public com.microsoft.bingads.v11.campaignmanagement.ICampaignManagementService getBasicHttpBinding_ICampaignManagementService() throws javax.xml.rpc.ServiceException {
    ...
    public com.microsoft.bingads.v11.campaignmanagement.ICampaignManagementService getBasicHttpBinding_ICampaignManagementService(java.net.URL portAddress) {
        try {
            com.microsoft.bingads.v11.campaignmanagement.BasicHttpBinding_ICampaignManagementServiceStub _stub = new com.microsoft.bingads.v11.campaignmanagement.BasicHttpBinding_ICampaignManagementServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.microsoft.bingads.v11.campaignmanagement.ICampaignManagementService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.bingads.v11.campaignmanagement.BasicHttpBinding_ICampaignManagementServiceStub _stub = new com.microsoft.bingads.v11.campaignmanagement.BasicHttpBinding_ICampaignManagementServiceStub(new java.net.URL(BasicHttpBinding_ICampaignManagementService_address), this);
                _stub.setPortName(getBasicHttpBinding_ICampaignManagementServiceWSDDServiceName());
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", "CampaignManagementService");
    }

    public java.util.Iterator getPorts() {
        if (ports == null) {
            ports = new java.util.HashSet();
            ports.add(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", "BasicHttpBinding_ICampaignManagementService"));
        }
