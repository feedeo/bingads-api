...
public class DeleteAdGroupsResponse implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">DeleteAdGroupsResponse"));
    ...
    /**
     * Gets the partialErrors value for this DeleteAdGroupsResponse.
     *
    ...
    /**
     * Sets the partialErrors value for this DeleteAdGroupsResponse.
     *
     * @param partialErrors
     */
