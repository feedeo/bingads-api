...
public class DeleteLabelsResponse implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v11", ">DeleteLabelsResponse"));
    ...
    /**
     * Gets the partialErrors value for this DeleteLabelsResponse.
     *
    ...
    /**
     * Sets the partialErrors value for this DeleteLabelsResponse.
     *
     * @param partialErrors
     */
