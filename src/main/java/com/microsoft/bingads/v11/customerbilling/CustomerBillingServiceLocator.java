...
public class CustomerBillingServiceLocator extends org.apache.axis.client.Service implements com.microsoft.bingads.v11.customerbilling.CustomerBillingService {

    // Use to get a proxy class for BasicHttpBinding_ICustomerBillingService
    private java.lang.String BasicHttpBinding_ICustomerBillingService_address = "https://clientcenter.api.bingads.microsoft.com/Api/Billing/v11/CustomerBillingService.svc";
    ...
    public com.microsoft.bingads.v11.customerbilling.ICustomerBillingService getBasicHttpBinding_ICustomerBillingService() throws javax.xml.rpc.ServiceException {
    ...
    public com.microsoft.bingads.v11.customerbilling.ICustomerBillingService getBasicHttpBinding_ICustomerBillingService(java.net.URL portAddress) {
        try {
            com.microsoft.bingads.v11.customerbilling.BasicHttpBinding_ICustomerBillingServiceStub _stub = new com.microsoft.bingads.v11.customerbilling.BasicHttpBinding_ICustomerBillingServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.microsoft.bingads.v11.customerbilling.ICustomerBillingService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.bingads.v11.customerbilling.BasicHttpBinding_ICustomerBillingServiceStub _stub = new com.microsoft.bingads.v11.customerbilling.BasicHttpBinding_ICustomerBillingServiceStub(new java.net.URL(BasicHttpBinding_ICustomerBillingService_address), this);
                _stub.setPortName(getBasicHttpBinding_ICustomerBillingServiceWSDDServiceName());
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://bingads.microsoft.com/Billing/v11", "CustomerBillingService");
    }

    public java.util.Iterator getPorts() {
        if (ports == null) {
            ports = new java.util.HashSet();
            ports.add(new javax.xml.namespace.QName("https://bingads.microsoft.com/Billing/v11", "BasicHttpBinding_ICustomerBillingService"));
        }
