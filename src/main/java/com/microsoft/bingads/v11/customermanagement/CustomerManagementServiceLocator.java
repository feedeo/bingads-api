...
public class CustomerManagementServiceLocator extends org.apache.axis.client.Service implements com.microsoft.bingads.v11.customermanagement.CustomerManagementService {

    // Use to get a proxy class for BasicHttpBinding_ICustomerManagementService
    private java.lang.String BasicHttpBinding_ICustomerManagementService_address = "https://clientcenter.api.bingads.microsoft.com/Api/CustomerManagement/v11/CustomerManagementService.svc";
    ...
    public com.microsoft.bingads.v11.customermanagement.ICustomerManagementService getBasicHttpBinding_ICustomerManagementService() throws javax.xml.rpc.ServiceException {
    ...
    public com.microsoft.bingads.v11.customermanagement.ICustomerManagementService getBasicHttpBinding_ICustomerManagementService(java.net.URL portAddress) {
        try {
            com.microsoft.bingads.v11.customermanagement.BasicHttpBinding_ICustomerManagementServiceStub _stub = new com.microsoft.bingads.v11.customermanagement.BasicHttpBinding_ICustomerManagementServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.microsoft.bingads.v11.customermanagement.ICustomerManagementService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.bingads.v11.customermanagement.BasicHttpBinding_ICustomerManagementServiceStub _stub = new com.microsoft.bingads.v11.customermanagement.BasicHttpBinding_ICustomerManagementServiceStub(new java.net.URL(BasicHttpBinding_ICustomerManagementService_address), this);
                _stub.setPortName(getBasicHttpBinding_ICustomerManagementServiceWSDDServiceName());
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v11", "CustomerManagementService");
    }

    public java.util.Iterator getPorts() {
        if (ports == null) {
            ports = new java.util.HashSet();
            ports.add(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v11", "BasicHttpBinding_ICustomerManagementService"));
        }
