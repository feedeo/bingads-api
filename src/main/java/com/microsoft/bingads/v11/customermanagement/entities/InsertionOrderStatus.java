...
public class InsertionOrderStatus implements java.io.Serializable {
    ...
    public static final java.lang.String _Exhausted = "Exhausted";
    ...
    public static final InsertionOrderStatus Pending = new InsertionOrderStatus(_Pending);
    public static final InsertionOrderStatus Exhausted = new InsertionOrderStatus(_Exhausted);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v11/Entities", "InsertionOrderStatus"));
    }
