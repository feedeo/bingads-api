...
public class UserLifeCycleStatus implements java.io.Serializable {
    ...
    public static final UserLifeCycleStatus Pending = new UserLifeCycleStatus(_Pending);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v11/Entities", "UserLifeCycleStatus"));
    }
