...
public class GetUsersInfoRequest implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v11", ">GetUsersInfoRequest"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v11", "StatusFilter"));
    ...
    private com.microsoft.bingads.v11.customermanagement.entities.UserLifeCycleStatus statusFilter;
    ...
    public GetUsersInfoRequest(
            ...
            com.microsoft.bingads.v11.customermanagement.entities.UserLifeCycleStatus statusFilter) {
     ...
     * @return statusFilter
     */
    public com.microsoft.bingads.v11.customermanagement.entities.UserLifeCycleStatus getStatusFilter() {
        return statusFilter;
    }
     ...
     * @param statusFilter
     */
    public void setStatusFilter(com.microsoft.bingads.v11.customermanagement.entities.UserLifeCycleStatus statusFilter) {
        this.statusFilter = statusFilter;
    }
