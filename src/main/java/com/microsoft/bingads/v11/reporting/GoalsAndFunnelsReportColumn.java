...
public class GoalsAndFunnelsReportColumn implements java.io.Serializable {
    ...
    public static final java.lang.String _GoalType = "GoalType";
    ...
    public static final GoalsAndFunnelsReportColumn GoalType = new GoalsAndFunnelsReportColumn(_GoalType);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v11", "GoalsAndFunnelsReportColumn"));
    }
