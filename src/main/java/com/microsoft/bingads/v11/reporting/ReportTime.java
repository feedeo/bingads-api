...
public class ReportTime implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v11", "ReportTime"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v11", "ReportTimePeriod"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
    ...
    private com.microsoft.bingads.v11.reporting.ReportTimePeriod predefinedTime;
    ...
    public ReportTime(
            ...
            com.microsoft.bingads.v11.reporting.ReportTimePeriod predefinedTime) {
     ...
     */
    public com.microsoft.bingads.v11.reporting.ReportTimePeriod getPredefinedTime() {
        return predefinedTime;
    }
     ...
     */
    public void setPredefinedTime(com.microsoft.bingads.v11.reporting.ReportTimePeriod predefinedTime) {
        this.predefinedTime = predefinedTime;
    }
