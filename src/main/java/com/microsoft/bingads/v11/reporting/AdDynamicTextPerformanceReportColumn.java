...
public class AdDynamicTextPerformanceReportColumn implements java.io.Serializable {
    ...
    public static final AdDynamicTextPerformanceReportColumn AccountId = new AdDynamicTextPerformanceReportColumn(_AccountId);
    ...
    public static final AdDynamicTextPerformanceReportColumn AccountStatus = new AdDynamicTextPerformanceReportColumn(_AccountStatus);
    public static final AdDynamicTextPerformanceReportColumn AdGroupStatus = new AdDynamicTextPerformanceReportColumn(_AdGroupStatus);
    public static final AdDynamicTextPerformanceReportColumn AdStatus = new AdDynamicTextPerformanceReportColumn(_AdStatus);
    public static final AdDynamicTextPerformanceReportColumn KeywordStatus = new AdDynamicTextPerformanceReportColumn(_KeywordStatus);
    public static final AdDynamicTextPerformanceReportColumn TitlePart1 = new AdDynamicTextPerformanceReportColumn(_TitlePart1);
    public static final AdDynamicTextPerformanceReportColumn TitlePart2 = new AdDynamicTextPerformanceReportColumn(_TitlePart2);
    public static final AdDynamicTextPerformanceReportColumn Path1 = new AdDynamicTextPerformanceReportColumn(_Path1);
    public static final AdDynamicTextPerformanceReportColumn Path2 = new AdDynamicTextPerformanceReportColumn(_Path2);
    public static final AdDynamicTextPerformanceReportColumn FinalURL = new AdDynamicTextPerformanceReportColumn(_FinalURL);
    public static final AdDynamicTextPerformanceReportColumn FinalMobileURL = new AdDynamicTextPerformanceReportColumn(_FinalMobileURL);
    public static final AdDynamicTextPerformanceReportColumn FinalAppURL = new AdDynamicTextPerformanceReportColumn(_FinalAppURL);
    public static final AdDynamicTextPerformanceReportColumn AdDescription = new AdDynamicTextPerformanceReportColumn(_AdDescription);
    public static final AdDynamicTextPerformanceReportColumn AdLabels = new AdDynamicTextPerformanceReportColumn(_AdLabels);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v11", "AdDynamicTextPerformanceReportColumn"));
    }
