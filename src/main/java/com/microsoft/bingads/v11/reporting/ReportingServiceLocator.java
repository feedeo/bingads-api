...
public class ReportingServiceLocator extends org.apache.axis.client.Service implements com.microsoft.bingads.v11.reporting.ReportingService {

    // Use to get a proxy class for BasicHttpBinding_IReportingService
    private java.lang.String BasicHttpBinding_IReportingService_address = "https://reporting.api.bingads.microsoft.com/Api/Advertiser/Reporting/V11/ReportingService.svc";
    ...
    public com.microsoft.bingads.v11.reporting.IReportingService getBasicHttpBinding_IReportingService() throws javax.xml.rpc.ServiceException {
    ...
    public com.microsoft.bingads.v11.reporting.IReportingService getBasicHttpBinding_IReportingService(java.net.URL portAddress) {
        try {
            com.microsoft.bingads.v11.reporting.BasicHttpBinding_IReportingServiceStub _stub = new com.microsoft.bingads.v11.reporting.BasicHttpBinding_IReportingServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.microsoft.bingads.v11.reporting.IReportingService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.bingads.v11.reporting.BasicHttpBinding_IReportingServiceStub _stub = new com.microsoft.bingads.v11.reporting.BasicHttpBinding_IReportingServiceStub(new java.net.URL(BasicHttpBinding_IReportingService_address), this);
                _stub.setPortName(getBasicHttpBinding_IReportingServiceWSDDServiceName());
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v11", "ReportingService");
    }

    public java.util.Iterator getPorts() {
        if (ports == null) {
            ports = new java.util.HashSet();
            ports.add(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v11", "BasicHttpBinding_IReportingService"));
        }
