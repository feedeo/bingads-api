...
public class ArrayOfOperationError  implements java.io.Serializable {
    private com.microsoft.bingads.v9.customermanagement.exception.OperationError[] operationError;

    public ArrayOfOperationError() {
    }

    public ArrayOfOperationError(
           com.microsoft.bingads.v9.customermanagement.exception.OperationError[] operationError) {
     ...
     */
    public com.microsoft.bingads.v9.customermanagement.exception.OperationError[] getOperationError() {
        return operationError;
    }
     ...
     */
    public void setOperationError(com.microsoft.bingads.v9.customermanagement.exception.OperationError[] operationError) {
        this.operationError = operationError;
    }

    public com.microsoft.bingads.v9.customermanagement.exception.OperationError getOperationError(int i) {
        return this.operationError[i];
    }

    public void setOperationError(int i, com.microsoft.bingads.v9.customermanagement.exception.OperationError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v9/Exception", "ArrayOfOperationError"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("operationError");
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v9/Exception", "OperationError"));
