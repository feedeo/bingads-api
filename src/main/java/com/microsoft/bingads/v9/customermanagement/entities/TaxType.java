...
public class TaxType implements java.io.Serializable {
    ...
    public static final TaxType Personal = new TaxType(_Personal);
    public static final TaxType Business = new TaxType(_Business);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v9/Entities", "TaxType"));
    }
    /**
