...
public class TaxIdStatus implements java.io.Serializable {
  ...
  public static final TaxIdStatus Valid = new TaxIdStatus(_Valid);
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v9/Entities", "TaxIdStatus"));
  }

  private java.lang.String _value_;

  // Constructor
  protected TaxIdStatus(java.lang.String value) {
    _value_ = value;
    _table_.put(_value_, this);
  }

  public static TaxIdStatus fromValue(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    TaxIdStatus enumeration = (TaxIdStatus)
            _table_.get(value);
    if (enumeration == null) throw new java.lang.IllegalArgumentException();
    return enumeration;
  }

  public static TaxIdStatus fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
