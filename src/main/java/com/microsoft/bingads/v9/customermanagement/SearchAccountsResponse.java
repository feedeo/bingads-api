...
public class SearchAccountsResponse implements java.io.Serializable {
  ...
  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v9", ">SearchAccountsResponse"));
    ...
    elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Customer/v9/Entities", "Account"));
    typeDesc.addFieldDesc(elemField);
  }

  private com.microsoft.bingads.v9.customermanagement.entities.Account[] accounts;
  ...
  public SearchAccountsResponse(
          com.microsoft.bingads.v9.customermanagement.entities.Account[] accounts) {
   ...
   * @return accounts
   */
  public com.microsoft.bingads.v9.customermanagement.entities.Account[] getAccounts() {
    return accounts;
  }
   ...
   * @param accounts
   */
  public void setAccounts(com.microsoft.bingads.v9.customermanagement.entities.Account[] accounts) {
    this.accounts = accounts;
  }
