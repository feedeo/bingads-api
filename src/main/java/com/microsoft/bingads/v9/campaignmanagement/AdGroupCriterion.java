...
public class AdGroupCriterion  implements java.io.Serializable {
    ...
    private com.microsoft.bingads.v9.campaignmanagement.Criterion criterion;

    private java.lang.Long id;

    private com.microsoft.bingads.v9.campaignmanagement.AdGroupCriterionStatus status;
     ...
     * @return criterion
     */
    public com.microsoft.bingads.v9.campaignmanagement.Criterion getCriterion() {
        return criterion;
    }
     ...
     * @param criterion
     */
    public void setCriterion(com.microsoft.bingads.v9.campaignmanagement.Criterion criterion) {
        this.criterion = criterion;
    }
     ...
     * @return status
     */
    public com.microsoft.bingads.v9.campaignmanagement.AdGroupCriterionStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.microsoft.bingads.v9.campaignmanagement.AdGroupCriterionStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "AdGroupCriterion"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "Criterion"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "Criterion"));
        elemField.setMinOccurs(0);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "AdGroupCriterionStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
