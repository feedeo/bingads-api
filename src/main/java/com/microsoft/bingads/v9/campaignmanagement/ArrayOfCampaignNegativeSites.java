...
public class ArrayOfCampaignNegativeSites  implements java.io.Serializable {
    ...
    /**
     * Gets the campaignNegativeSites value for this ArrayOfCampaignNegativeSites.
     * 
    ...
    /**
     * Sets the campaignNegativeSites value for this ArrayOfCampaignNegativeSites.
     * 
    ...
    public com.microsoft.bingads.v9.campaignmanagement.CampaignNegativeSites getCampaignNegativeSites(int i) {
        return this.campaignNegativeSites[i];
    }

    public void setCampaignNegativeSites(int i, com.microsoft.bingads.v9.campaignmanagement.CampaignNegativeSites _value) {
        this.campaignNegativeSites[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfCampaignNegativeSites)) return false;
        ArrayOfCampaignNegativeSites other = (ArrayOfCampaignNegativeSites) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfCampaignNegativeSites.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "ArrayOfCampaignNegativeSites"));
