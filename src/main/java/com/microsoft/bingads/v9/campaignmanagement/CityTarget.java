...
public class CityTarget  implements java.io.Serializable {
    private com.microsoft.bingads.v9.campaignmanagement.CityTargetBid[] bids;

    public CityTarget() {
    }

    public CityTarget(
           com.microsoft.bingads.v9.campaignmanagement.CityTargetBid[] bids) {
           this.bids = bids;
    }
     ...
     * @return bids
     */
    public com.microsoft.bingads.v9.campaignmanagement.CityTargetBid[] getBids() {
        return bids;
    }
     ...
     * @param bids
     */
    public void setBids(com.microsoft.bingads.v9.campaignmanagement.CityTargetBid[] bids) {
        this.bids = bids;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "CityTargetBid"));
