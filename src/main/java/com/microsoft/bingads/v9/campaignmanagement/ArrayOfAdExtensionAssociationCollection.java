/**
 * ArrayOfAdExtensionAssociationCollection.java
 *
...
public class ArrayOfAdExtensionAssociationCollection  implements java.io.Serializable {
    ...
    /**
     * Gets the adExtensionAssociationCollection value for this ArrayOfAdExtensionAssociationCollection.
     * 
    ...
    /**
     * Sets the adExtensionAssociationCollection value for this ArrayOfAdExtensionAssociationCollection.
     * 
    ...
    public com.microsoft.bingads.v9.campaignmanagement.AdExtensionAssociationCollection getAdExtensionAssociationCollection(int i) {
        return this.adExtensionAssociationCollection[i];
    }

    public void setAdExtensionAssociationCollection(int i, com.microsoft.bingads.v9.campaignmanagement.AdExtensionAssociationCollection _value) {
        this.adExtensionAssociationCollection[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfAdExtensionAssociationCollection)) return false;
        ArrayOfAdExtensionAssociationCollection other = (ArrayOfAdExtensionAssociationCollection) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfAdExtensionAssociationCollection.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "ArrayOfAdExtensionAssociationCollection"));
