...
public class ArrayOfAdGroupNegativeKeywords  implements java.io.Serializable {
    private com.microsoft.bingads.v9.campaignmanagement.AdGroupNegativeKeywords[] adGroupNegativeKeywords;

    public ArrayOfAdGroupNegativeKeywords() {
    }
    ...
    /**
     * Gets the adGroupNegativeKeywords value for this ArrayOfAdGroupNegativeKeywords.
     * 
    ...
    /**
     * Sets the adGroupNegativeKeywords value for this ArrayOfAdGroupNegativeKeywords.
     * 
    ...
    public com.microsoft.bingads.v9.campaignmanagement.AdGroupNegativeKeywords getAdGroupNegativeKeywords(int i) {
        return this.adGroupNegativeKeywords[i];
    }

    public void setAdGroupNegativeKeywords(int i, com.microsoft.bingads.v9.campaignmanagement.AdGroupNegativeKeywords _value) {
        this.adGroupNegativeKeywords[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfAdGroupNegativeKeywords)) return false;
        ArrayOfAdGroupNegativeKeywords other = (ArrayOfAdGroupNegativeKeywords) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfAdGroupNegativeKeywords.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "ArrayOfAdGroupNegativeKeywords"));
