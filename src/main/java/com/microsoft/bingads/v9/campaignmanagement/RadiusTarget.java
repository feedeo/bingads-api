...
public class RadiusTarget  implements java.io.Serializable {
    private com.microsoft.bingads.v9.campaignmanagement.RadiusTargetBid[] bids;

    public RadiusTarget() {
    }

    public RadiusTarget(
           com.microsoft.bingads.v9.campaignmanagement.RadiusTargetBid[] bids) {
           this.bids = bids;
    }
     ...
     * @return bids
     */
    public com.microsoft.bingads.v9.campaignmanagement.RadiusTargetBid[] getBids() {
        return bids;
    }
     ...
     * @param bids
     */
    public void setBids(com.microsoft.bingads.v9.campaignmanagement.RadiusTargetBid[] bids) {
        this.bids = bids;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "RadiusTargetBid"));
