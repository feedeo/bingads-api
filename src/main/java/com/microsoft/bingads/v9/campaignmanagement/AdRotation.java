...
public class AdRotation  implements java.io.Serializable {
    ...
    private com.microsoft.bingads.v9.campaignmanagement.AdRotationType type;
    ...
    public AdRotation(
           ...
           com.microsoft.bingads.v9.campaignmanagement.AdRotationType type) {
     ...
     * @return type
     */
    public com.microsoft.bingads.v9.campaignmanagement.AdRotationType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.microsoft.bingads.v9.campaignmanagement.AdRotationType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "AdRotation"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "AdRotationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
