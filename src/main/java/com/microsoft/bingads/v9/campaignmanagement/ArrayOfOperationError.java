...
public class ArrayOfOperationError  implements java.io.Serializable {
    private com.microsoft.bingads.v9.campaignmanagement.OperationError[] operationError;

    public ArrayOfOperationError() {
    }

    public ArrayOfOperationError(
           com.microsoft.bingads.v9.campaignmanagement.OperationError[] operationError) {
     ...
     */
    public com.microsoft.bingads.v9.campaignmanagement.OperationError[] getOperationError() {
        return operationError;
    }
     ...
     */
    public void setOperationError(com.microsoft.bingads.v9.campaignmanagement.OperationError[] operationError) {
        this.operationError = operationError;
    }

    public com.microsoft.bingads.v9.campaignmanagement.OperationError getOperationError(int i) {
        return this.operationError[i];
    }

    public void setOperationError(int i, com.microsoft.bingads.v9.campaignmanagement.OperationError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "ArrayOfOperationError"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("operationError");
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "OperationError"));
