...
public class AgeTarget  implements java.io.Serializable {
    private com.microsoft.bingads.v9.campaignmanagement.AgeTargetBid[] bids;

    public AgeTarget() {
    }

    public AgeTarget(
           com.microsoft.bingads.v9.campaignmanagement.AgeTargetBid[] bids) {
           this.bids = bids;
    }
     ...
     * @return bids
     */
    public com.microsoft.bingads.v9.campaignmanagement.AgeTargetBid[] getBids() {
        return bids;
    }
     ...
     * @param bids
     */
    public void setBids(com.microsoft.bingads.v9.campaignmanagement.AgeTargetBid[] bids) {
        this.bids = bids;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "AgeTargetBid"));
