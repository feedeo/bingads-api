...
public class BulkServiceLocator extends org.apache.axis.client.Service implements com.microsoft.bingads.v9.campaignmanagement.BulkService {
    ...
    public com.microsoft.bingads.v9.campaignmanagement.IBulkService getBasicHttpBinding_IBulkService() throws javax.xml.rpc.ServiceException {
    ...
    public com.microsoft.bingads.v9.campaignmanagement.IBulkService getBasicHttpBinding_IBulkService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.microsoft.bingads.v9.campaignmanagement.BasicHttpBinding_IBulkServiceStub _stub = new com.microsoft.bingads.v9.campaignmanagement.BasicHttpBinding_IBulkServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.microsoft.bingads.v9.campaignmanagement.IBulkService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.bingads.v9.campaignmanagement.BasicHttpBinding_IBulkServiceStub _stub = new com.microsoft.bingads.v9.campaignmanagement.BasicHttpBinding_IBulkServiceStub(new java.net.URL(BasicHttpBinding_IBulkService_address), this);
                _stub.setPortName(getBasicHttpBinding_IBulkServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "BulkService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "BasicHttpBinding_IBulkService"));
        }
