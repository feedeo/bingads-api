...
public class UpdateKeywordsResponse  implements java.io.Serializable, HasPartialErrors {
    ...
    /**
     * Gets the partialErrors value for this UpdateKeywordsResponse.
     * 
    ...
    /**
     * Sets the partialErrors value for this UpdateKeywordsResponse.
     * 
     * @param partialErrors
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", ">UpdateKeywordsResponse"));
