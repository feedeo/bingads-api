...
public class DeviceOSTarget  implements java.io.Serializable {
    private com.microsoft.bingads.v9.campaignmanagement.DeviceOSTargetBid[] bids;

    public DeviceOSTarget() {
    }

    public DeviceOSTarget(
           com.microsoft.bingads.v9.campaignmanagement.DeviceOSTargetBid[] bids) {
           this.bids = bids;
    }
     ...
     * @return bids
     */
    public com.microsoft.bingads.v9.campaignmanagement.DeviceOSTargetBid[] getBids() {
        return bids;
    }
     ...
     * @param bids
     */
    public void setBids(com.microsoft.bingads.v9.campaignmanagement.DeviceOSTargetBid[] bids) {
        this.bids = bids;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "DeviceOSTargetBid"));
