...
public class GenderTargetBid  implements java.io.Serializable {
    ...
    private com.microsoft.bingads.v9.campaignmanagement.GenderType gender;
    ...
    public GenderTargetBid(
           int bidAdjustment,
           com.microsoft.bingads.v9.campaignmanagement.GenderType gender) {
     ...
     * @return gender
     */
    public com.microsoft.bingads.v9.campaignmanagement.GenderType getGender() {
        return gender;
    }
     ...
     * @param gender
     */
    public void setGender(com.microsoft.bingads.v9.campaignmanagement.GenderType gender) {
        this.gender = gender;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "GenderTargetBid"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "GenderType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
