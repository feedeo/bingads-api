...
public class StateTarget  implements java.io.Serializable {
    private com.microsoft.bingads.v9.campaignmanagement.ArrayOfStateTargetBid bids;

    public StateTarget() {
    }

    public StateTarget(
           com.microsoft.bingads.v9.campaignmanagement.ArrayOfStateTargetBid bids) {
           this.bids = bids;
    }
     ...
     * @return bids
     */
    public com.microsoft.bingads.v9.campaignmanagement.ArrayOfStateTargetBid getBids() {
        return bids;
    }
     ...
     * @param bids
     */
    public void setBids(com.microsoft.bingads.v9.campaignmanagement.ArrayOfStateTargetBid bids) {
        this.bids = bids;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "ArrayOfStateTargetBid"));
