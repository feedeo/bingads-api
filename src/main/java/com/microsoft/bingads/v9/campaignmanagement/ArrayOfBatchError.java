...
public class ArrayOfBatchError  implements java.io.Serializable {
    private com.microsoft.bingads.v9.campaignmanagement.BatchError[] batchError;

    public ArrayOfBatchError() {
    }

    public ArrayOfBatchError(
           com.microsoft.bingads.v9.campaignmanagement.BatchError[] batchError) {
     ...
     * @return batchError
     */
    public com.microsoft.bingads.v9.campaignmanagement.BatchError[] getBatchError() {
        return batchError;
    }
     ...
     * @param batchError
     */
    public void setBatchError(com.microsoft.bingads.v9.campaignmanagement.BatchError[] batchError) {
        this.batchError = batchError;
    }

    public com.microsoft.bingads.v9.campaignmanagement.BatchError getBatchError(int i) {
        return this.batchError[i];
    }

    public void setBatchError(int i, com.microsoft.bingads.v9.campaignmanagement.BatchError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "ArrayOfBatchError"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("batchError");
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/CampaignManagement/v9", "BatchError"));
