...
public class AdExtensionByKeywordReportRequest  extends com.microsoft.bingads.v9.reporting.ReportRequest  implements java.io.Serializable {
    private com.microsoft.bingads.v9.reporting.ReportAggregation aggregation;

    private com.microsoft.bingads.v9.reporting.ArrayOfAdExtensionByKeywordReportColumn columns;

    private com.microsoft.bingads.v9.reporting.AdExtensionByKeywordReportFilter filter;
    ...
    public AdExtensionByKeywordReportRequest(
           ...
           com.microsoft.bingads.v9.reporting.ArrayOfAdExtensionByKeywordReportColumn columns,
           com.microsoft.bingads.v9.reporting.AdExtensionByKeywordReportFilter filter,
     ...
     * @return columns
     */
    public com.microsoft.bingads.v9.reporting.ArrayOfAdExtensionByKeywordReportColumn getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.microsoft.bingads.v9.reporting.ArrayOfAdExtensionByKeywordReportColumn columns) {
        this.columns = columns;
    }
     ...
     * @return filter
     */
    public com.microsoft.bingads.v9.reporting.AdExtensionByKeywordReportFilter getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.microsoft.bingads.v9.reporting.AdExtensionByKeywordReportFilter filter) {
        this.filter = filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "AdExtensionByKeywordReportRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "ArrayOfAdExtensionByKeywordReportColumn"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filter");
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "Filter"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "AdExtensionByKeywordReportFilter"));
