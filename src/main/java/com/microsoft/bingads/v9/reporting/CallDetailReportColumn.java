...
public class CallDetailReportColumn implements java.io.Serializable {
    ...
    public static final CallDetailReportColumn PhoneSpend = new CallDetailReportColumn(_PhoneSpend);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "CallDetailReportColumn"));
    }
