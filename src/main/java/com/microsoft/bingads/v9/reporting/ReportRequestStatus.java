...
public class ReportRequestStatus  implements java.io.Serializable {
    ...
    private com.microsoft.bingads.v9.reporting.ReportRequestStatusType status;
    ...
    public ReportRequestStatus(
           ...
           com.microsoft.bingads.v9.reporting.ReportRequestStatusType status) {
     ...
     * @return status
     */
    public com.microsoft.bingads.v9.reporting.ReportRequestStatusType getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.microsoft.bingads.v9.reporting.ReportRequestStatusType status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "ReportRequestStatus"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("reportDownloadUrl");
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "ReportDownloadUrl"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "ReportRequestStatusType"));
        elemField.setMinOccurs(0);
