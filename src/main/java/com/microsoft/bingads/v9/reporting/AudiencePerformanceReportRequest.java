...
public class AudiencePerformanceReportRequest extends com.microsoft.bingads.v9.reporting.ReportRequest implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(AudiencePerformanceReportRequest.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "AudiencePerformanceReportRequest"));
    ...
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "AudiencePerformanceReportColumn"));
    elemField.setNillable(true);
    elemField.setItemQName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "AudiencePerformanceReportColumn"));
    typeDesc.addFieldDesc(elemField);
    elemField = new org.apache.axis.description.ElementDesc();
    elemField.setFieldName("filter");
    elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "Filter"));
    elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "AudiencePerformanceReportFilter"));
  ...
  private com.microsoft.bingads.v9.reporting.AudiencePerformanceReportColumn[] columns;
  private com.microsoft.bingads.v9.reporting.AudiencePerformanceReportFilter filter;
  ...
  public AudiencePerformanceReportRequest(
          ...
          com.microsoft.bingads.v9.reporting.AudiencePerformanceReportColumn[] columns,
          com.microsoft.bingads.v9.reporting.AudiencePerformanceReportFilter filter,
   ...
   * @return columns
   */
  public com.microsoft.bingads.v9.reporting.AudiencePerformanceReportColumn[] getColumns() {
    return columns;
  }
   ...
   * @param columns
   */
  public void setColumns(com.microsoft.bingads.v9.reporting.AudiencePerformanceReportColumn[] columns) {
    this.columns = columns;
  }
   ...
   * @return filter
   */
  public com.microsoft.bingads.v9.reporting.AudiencePerformanceReportFilter getFilter() {
    return filter;
  }
   ...
   * @param filter
   */
  public void setFilter(com.microsoft.bingads.v9.reporting.AudiencePerformanceReportFilter filter) {
    this.filter = filter;
  }
