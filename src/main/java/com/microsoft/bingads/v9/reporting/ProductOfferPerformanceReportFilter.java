/**
 * ProductOfferPerformanceReportFilter.java
 * <p>
...
public class ProductOfferPerformanceReportFilter implements java.io.Serializable {
  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
          new org.apache.axis.description.TypeDesc(ProductOfferPerformanceReportFilter.class, true);

  static {
    typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "ProductOfferPerformanceReportFilter"));
  ...
  public ProductOfferPerformanceReportFilter() {
  }
  ...
  /**
   * Gets the accountStatus value for this ProductOfferPerformanceReportFilter.
   *
  ...
  /**
   * Sets the accountStatus value for this ProductOfferPerformanceReportFilter.
   *
   * @param accountStatus
   */
  ...
  /**
   * Gets the adGroupStatus value for this ProductOfferPerformanceReportFilter.
   *
  ...
  /**
   * Sets the adGroupStatus value for this ProductOfferPerformanceReportFilter.
   *
   * @param adGroupStatus
   */
  ...
  /**
   * Gets the adStatus value for this ProductOfferPerformanceReportFilter.
   *
   * @return adStatus
   */
  ...
  /**
   * Sets the adStatus value for this ProductOfferPerformanceReportFilter.
   *
   * @param adStatus
   */
  ...
  /**
   * Gets the campaignStatus value for this ProductOfferPerformanceReportFilter.
   *
  ...
  /**
   * Sets the campaignStatus value for this ProductOfferPerformanceReportFilter.
   *
  ...
  /**
   * Gets the deviceType value for this ProductOfferPerformanceReportFilter.
   *
   * @return deviceType
   */
  ...
  /**
   * Sets the deviceType value for this ProductOfferPerformanceReportFilter.
   *
   * @param deviceType
   */
  ...
  /**
   * Gets the languageCode value for this ProductOfferPerformanceReportFilter.
   *
   * @return languageCode
   */
  ...
  /**
   * Sets the languageCode value for this ProductOfferPerformanceReportFilter.
   *
   * @param languageCode
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof ProductOfferPerformanceReportFilter)) return false;
    ProductOfferPerformanceReportFilter other = (ProductOfferPerformanceReportFilter) obj;
