...
public class PollGenerateReportResponse  implements java.io.Serializable {
    private com.microsoft.bingads.v9.reporting.ReportRequestStatus reportRequestStatus;

    public PollGenerateReportResponse() {
    }

    public PollGenerateReportResponse(
           com.microsoft.bingads.v9.reporting.ReportRequestStatus reportRequestStatus) {
     ...
     */
    public com.microsoft.bingads.v9.reporting.ReportRequestStatus getReportRequestStatus() {
        return reportRequestStatus;
    }
     ...
     */
    public void setReportRequestStatus(com.microsoft.bingads.v9.reporting.ReportRequestStatus reportRequestStatus) {
        this.reportRequestStatus = reportRequestStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", ">PollGenerateReportResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("reportRequestStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "ReportRequestStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "ReportRequestStatus"));
