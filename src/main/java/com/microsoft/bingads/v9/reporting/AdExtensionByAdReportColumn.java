...
public class AdExtensionByAdReportColumn implements java.io.Serializable {
    ...
    public static final AdExtensionByAdReportColumn BidMatchType = new AdExtensionByAdReportColumn(_BidMatchType);
    public static final AdExtensionByAdReportColumn DeliveredMatchType = new AdExtensionByAdReportColumn(_DeliveredMatchType);
    public static final AdExtensionByAdReportColumn Network = new AdExtensionByAdReportColumn(_Network);
    public static final AdExtensionByAdReportColumn TopVsOther = new AdExtensionByAdReportColumn(_TopVsOther);
    public static final AdExtensionByAdReportColumn Assists = new AdExtensionByAdReportColumn(_Assists);
    public static final AdExtensionByAdReportColumn ExtendedCost = new AdExtensionByAdReportColumn(_ExtendedCost);
    public static final AdExtensionByAdReportColumn Revenue = new AdExtensionByAdReportColumn(_Revenue);
    public static final AdExtensionByAdReportColumn ReturnOnAdSpend = new AdExtensionByAdReportColumn(_ReturnOnAdSpend);
    public static final AdExtensionByAdReportColumn CostPerConversion = new AdExtensionByAdReportColumn(_CostPerConversion);
    public static final AdExtensionByAdReportColumn CostPerAssist = new AdExtensionByAdReportColumn(_CostPerAssist);
    public static final AdExtensionByAdReportColumn RevenuePerConversion = new AdExtensionByAdReportColumn(_RevenuePerConversion);
    public static final AdExtensionByAdReportColumn RevenuePerAssist = new AdExtensionByAdReportColumn(_RevenuePerAssist);
    public static final AdExtensionByAdReportColumn AccountStatus = new AdExtensionByAdReportColumn(_AccountStatus);
    public static final AdExtensionByAdReportColumn CampaignStatus = new AdExtensionByAdReportColumn(_CampaignStatus);
    public static final AdExtensionByAdReportColumn AdGroupStatus = new AdExtensionByAdReportColumn(_AdGroupStatus);
    public static final AdExtensionByAdReportColumn AdStatus = new AdExtensionByAdReportColumn(_AdStatus);
