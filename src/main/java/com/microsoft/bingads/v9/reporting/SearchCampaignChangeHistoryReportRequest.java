...
public class SearchCampaignChangeHistoryReportRequest  extends com.microsoft.bingads.v9.reporting.ReportRequest  implements java.io.Serializable {
     ...
     * @return filter
     */
    public com.microsoft.bingads.v9.reporting.SearchCampaignChangeHistoryReportFilter getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.microsoft.bingads.v9.reporting.SearchCampaignChangeHistoryReportFilter filter) {
        this.filter = filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "SearchCampaignChangeHistoryReportRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "SearchCampaignChangeHistoryReportFilter"));
