...
public class RichAdComponentPerformanceReportColumn implements java.io.Serializable {
    ...
    public static final RichAdComponentPerformanceReportColumn AccountId = new RichAdComponentPerformanceReportColumn(_AccountId);
    ...
    public static final RichAdComponentPerformanceReportColumn CampaignId = new RichAdComponentPerformanceReportColumn(_CampaignId);
    ...
    public static final RichAdComponentPerformanceReportColumn AccountStatus = new RichAdComponentPerformanceReportColumn(_AccountStatus);
    public static final RichAdComponentPerformanceReportColumn CampaignStatus = new RichAdComponentPerformanceReportColumn(_CampaignStatus);
    public static final RichAdComponentPerformanceReportColumn AdGroupStatus = new RichAdComponentPerformanceReportColumn(_AdGroupStatus);
    public static final RichAdComponentPerformanceReportColumn AdStatus = new RichAdComponentPerformanceReportColumn(_AdStatus);
