...
public class SearchQueryPerformanceReportRequest  extends com.microsoft.bingads.v9.reporting.ReportRequest  implements java.io.Serializable {
     ...
     * @return aggregation
     */
    public com.microsoft.bingads.v9.reporting.SearchQueryReportAggregation getAggregation() {
        return aggregation;
    }
     ...
     * @param aggregation
     */
    public void setAggregation(com.microsoft.bingads.v9.reporting.SearchQueryReportAggregation aggregation) {
        this.aggregation = aggregation;
    }
     ...
     * @return filter
     */
    public com.microsoft.bingads.v9.reporting.SearchQueryPerformanceReportFilter getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.microsoft.bingads.v9.reporting.SearchQueryPerformanceReportFilter filter) {
        this.filter = filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "SearchQueryPerformanceReportRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "SearchQueryReportAggregation"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "SearchQueryPerformanceReportFilter"));
