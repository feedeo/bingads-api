...
public class AdPerformanceReportRequest  extends com.microsoft.bingads.v9.reporting.ReportRequest  implements java.io.Serializable {
    private com.microsoft.bingads.v9.reporting.NonHourlyReportAggregation aggregation;

    private com.microsoft.bingads.v9.reporting.ArrayOfAdPerformanceReportColumn columns;

    private com.microsoft.bingads.v9.reporting.AdPerformanceReportFilter filter;
    ...
    public AdPerformanceReportRequest(
           ...
           com.microsoft.bingads.v9.reporting.ArrayOfAdPerformanceReportColumn columns,
           com.microsoft.bingads.v9.reporting.AdPerformanceReportFilter filter,
     ...
     * @return columns
     */
    public com.microsoft.bingads.v9.reporting.ArrayOfAdPerformanceReportColumn getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.microsoft.bingads.v9.reporting.ArrayOfAdPerformanceReportColumn columns) {
        this.columns = columns;
    }
     ...
     * @return filter
     */
    public com.microsoft.bingads.v9.reporting.AdPerformanceReportFilter getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.microsoft.bingads.v9.reporting.AdPerformanceReportFilter filter) {
        this.filter = filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "AdPerformanceReportRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "ArrayOfAdPerformanceReportColumn"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filter");
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "Filter"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "AdPerformanceReportFilter"));
