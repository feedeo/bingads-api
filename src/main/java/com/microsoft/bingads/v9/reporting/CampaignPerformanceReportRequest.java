...
public class CampaignPerformanceReportRequest  extends com.microsoft.bingads.v9.reporting.ReportRequest  implements java.io.Serializable {
    private com.microsoft.bingads.v9.reporting.ReportAggregation aggregation;

    private com.microsoft.bingads.v9.reporting.ArrayOfCampaignPerformanceReportColumn columns;

    private com.microsoft.bingads.v9.reporting.CampaignPerformanceReportFilter filter;
    ...
    public CampaignPerformanceReportRequest(
           ...
           com.microsoft.bingads.v9.reporting.ArrayOfCampaignPerformanceReportColumn columns,
           com.microsoft.bingads.v9.reporting.CampaignPerformanceReportFilter filter,
     ...
     * @return columns
     */
    public com.microsoft.bingads.v9.reporting.ArrayOfCampaignPerformanceReportColumn getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.microsoft.bingads.v9.reporting.ArrayOfCampaignPerformanceReportColumn columns) {
        this.columns = columns;
    }
     ...
     * @return filter
     */
    public com.microsoft.bingads.v9.reporting.CampaignPerformanceReportFilter getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.microsoft.bingads.v9.reporting.CampaignPerformanceReportFilter filter) {
        this.filter = filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "CampaignPerformanceReportRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "ArrayOfCampaignPerformanceReportColumn"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filter");
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "Filter"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "CampaignPerformanceReportFilter"));
