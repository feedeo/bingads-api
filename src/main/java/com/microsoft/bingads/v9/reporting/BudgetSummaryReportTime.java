...
public class BudgetSummaryReportTime  implements java.io.Serializable {
    ...
    private com.microsoft.bingads.v9.reporting.BudgetSummaryReportTimePeriod predefinedTime;
    ...
    public BudgetSummaryReportTime(
           ...
           com.microsoft.bingads.v9.reporting.BudgetSummaryReportTimePeriod predefinedTime) {
     ...
     */
    public com.microsoft.bingads.v9.reporting.BudgetSummaryReportTimePeriod getPredefinedTime() {
        return predefinedTime;
    }
     ...
     */
    public void setPredefinedTime(com.microsoft.bingads.v9.reporting.BudgetSummaryReportTimePeriod predefinedTime) {
        this.predefinedTime = predefinedTime;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "BudgetSummaryReportTime"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Reporting/v9", "BudgetSummaryReportTimePeriod"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
