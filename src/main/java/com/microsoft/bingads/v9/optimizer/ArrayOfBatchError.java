...
public class ArrayOfBatchError  implements java.io.Serializable {
    private com.microsoft.bingads.v9.optimizer.BatchError[] batchError;

    public ArrayOfBatchError() {
    }

    public ArrayOfBatchError(
           com.microsoft.bingads.v9.optimizer.BatchError[] batchError) {
     ...
     * @return batchError
     */
    public com.microsoft.bingads.v9.optimizer.BatchError[] getBatchError() {
        return batchError;
    }
     ...
     * @param batchError
     */
    public void setBatchError(com.microsoft.bingads.v9.optimizer.BatchError[] batchError) {
        this.batchError = batchError;
    }

    public com.microsoft.bingads.v9.optimizer.BatchError getBatchError(int i) {
        return this.batchError[i];
    }

    public void setBatchError(int i, com.microsoft.bingads.v9.optimizer.BatchError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Optimizer/v9", "ArrayOfBatchError"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("batchError");
        elemField.setXmlName(new javax.xml.namespace.QName("https://bingads.microsoft.com/Optimizer/v9", "BatchError"));
