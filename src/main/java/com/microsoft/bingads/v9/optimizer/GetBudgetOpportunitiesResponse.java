...
public class GetBudgetOpportunitiesResponse  implements java.io.Serializable {
    private com.microsoft.bingads.v9.optimizer.entities.ArrayOfBudgetOpportunity opportunities;

    public GetBudgetOpportunitiesResponse() {
    }

    public GetBudgetOpportunitiesResponse(
           com.microsoft.bingads.v9.optimizer.entities.ArrayOfBudgetOpportunity opportunities) {
     ...
     */
    public com.microsoft.bingads.v9.optimizer.entities.ArrayOfBudgetOpportunity getOpportunities() {
        return opportunities;
    }
     ...
     * @param opportunities
     */
    public void setOpportunities(com.microsoft.bingads.v9.optimizer.entities.ArrayOfBudgetOpportunity opportunities) {
        this.opportunities = opportunities;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://bingads.microsoft.com/Optimizer/v9", ">GetBudgetOpportunitiesResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.Optimizer.Api.DataContracts.Entities", "ArrayOfBudgetOpportunity"));
