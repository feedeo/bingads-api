...
public class GetBudgetOpportunitiesResponse  implements java.io.Serializable {
    private com.microsoft.bingads.v9.optimizer.entities.BudgetOpportunity[] opportunities;

    public GetBudgetOpportunitiesResponse() {
    }

    public GetBudgetOpportunitiesResponse(
           com.microsoft.bingads.v9.optimizer.entities.BudgetOpportunity[] opportunities) {
     ...
     */
    public com.microsoft.bingads.v9.optimizer.entities.BudgetOpportunity[] getOpportunities() {
        return opportunities;
    }
     ...
     * @param opportunities
     */
    public void setOpportunities(com.microsoft.bingads.v9.optimizer.entities.BudgetOpportunity[] opportunities) {
        this.opportunities = opportunities;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/Microsoft.BingAds.Advertiser.Optimizer.Api.DataContracts.Entities", "BudgetOpportunity"));
